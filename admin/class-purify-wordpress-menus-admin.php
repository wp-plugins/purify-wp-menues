...
class Purify_WordPress_Menus_Admin {
	 ...
	 * @var      array
	 */
	protected $main_options_page_slug = 'pwpm_options_page'; #purify_wp_menu_options_page
	 ...
	 * @var      array
	 */
	protected $settings_fields_slug = 'pwpm_options_group'; #purify_wp_menu_options_group
	...
	public function add_plugin_admin_menu() {
		...
		$this->plugin_screen_hook_suffix = add_options_page(
			sprintf( '%s %s', $this->plugin_name, __( 'Options', $this->plugin_slug ) ),
			$this->plugin_name,
			'manage_options',
			$this->plugin_slug,
			array( $this, 'main' )
	...
	*/
	public function register_options () {
		...
		$this->form_structure = array(
			'1st_section' => array(
				'headline' => __( 'Current Page Navigation Menu Items', $this->plugin_slug ),
				'description' => __( 'In this section you control the CSS class Wordpress adds to the current menu item.', $this->plugin_slug ),
				'options' => array(
					'pwpm_print_current_menu_item' => array(
						'title'   => '.current-menu-item',
						'label'   => __( 'This class is added to menu items that correspond to the currently rendered page.', $this->plugin_slug ),
					),
					'pwpm_print_current_page_item' => array(
						'title'   => '.current_page_item',
						'label'   => __( 'This class is added to page menu items that correspond to the currently rendered page.', $this->plugin_slug ),
					),
				),
			), // end 1st_section
			'2nd_section' => array(
				'headline' => __( 'General Menu Items', $this->plugin_slug ),
				'description' => __( 'In this section you control some general classes Wordpress adds to menu items.', $this->plugin_slug ),
				'options' => array(
					'pwpm_print_menu_item' => array(
						'title'   => '.menu-item',
						'label'   => __( 'This class is added to every menu item.', $this->plugin_slug ),
					),
					'pwpm_print_page_item' => array(
						'title'   => '.page_item',
						'label'   => __( 'This class is added to page menu items that correspond to a page.', $this->plugin_slug ),
					),
					'pwpm_print_menu_item_id_as_class' => array(
						'title'   => '.menu-item-{id}',
						'label'   => __( 'This class with the item id is added to every menu item.', $this->plugin_slug ),
					),
					'pwpm_print_page_item_id' => array(
						'title'   => '.page-item-{id}',
						'label'   => __( 'This class is added to page menu items that correspond to a page, where ID is the page ID.', $this->plugin_slug ),
					),
					'pwpm_print_menu_item_home' => array(
						'title'   => '.menu-item-home',
						'label'   => __( 'This class is added to menu items that correspond to the site front page.', $this->plugin_slug ),
					),
					'pwpm_print_menu_item_id' => array(
						'title'   => '#menu-item-{id}',
						'label'   => __( 'The id of the menu item is added to every menu item of navigation menus.', $this->plugin_slug ),
					),
				),
			), // end 2nd_section
			'3rd_section' => array(
				'headline' => __( 'Current Page Parent Menu Items', $this->plugin_slug ),
				'description' => __( 'In this section you control the CSS classes Wordpress adds to the hierarchical parent of the current menu item.', $this->plugin_slug ),
				'options' => array(
					'pwpm_print_current_menu_parent' => array(
						'title'   => '.current-menu-parent',
						'label'   => __( 'This class is added to menu items that correspond to the hierarchical parent of the currently rendered page.', $this->plugin_slug ),
					),
					'pwpm_print_current_page_parent' => array(
						'title'   => '.current_page_parent',
						'label'   => __( 'This class is added to page menu items that correspond to the hierarchical parent of the currently rendered page.', $this->plugin_slug ),
					),
					'pwpm_print_current_object_any_parent' => array(
						'title'   => '.current-{object}-parent',
						'label'   => __( 'This class is added to menu items that correspond to the hierachical parent of the currently rendered object, where {object} corresponds to the the value used for .menu-item-object-{object}.', $this->plugin_slug ),
					),
					'pwpm_print_current_type_any_parent' => array(
						'title'   => '.current-{type}-parent',
						'label'   => __( 'This class is added to menu items that correspond to the hierachical parent of the currently rendered type, where {type} corresponds to the the value used for .menu-item-type-{type}.', $this->plugin_slug ),
					),
				),
			), // end 3rd_section
			'4th_section' => array(
				'headline' => __( 'Current Page Ancestor Menu Items', $this->plugin_slug ),
				'description' => __( 'In this section you control the CSS classes Wordpress adds to the hierarchical anchestors of the current menu item.', $this->plugin_slug ),
				'options' => array(
					'pwpm_print_current_menu_ancestor' => array(
						'title'   => '.current-menu-ancestor',
						'label'   => __( 'This class is added to menu items that correspond to a hierarchical ancestor of the currently rendered page.', $this->plugin_slug ),
					),
					'pwpm_print_current_page_ancestor' => array(
						'title'   => '.current_page_ancestor',
						'label'   => __( 'This class is added to page menu items that correspond to a hierarchical ancestor of the currently rendered page.', $this->plugin_slug ),
					),
					'pwpm_print_current_object_any_ancestor' => array(
						'title'   => '.current-{object}-ancestor',
						'label'   => __( 'This class is added to menu items that correspond to a hierachical ancestor of the currently rendered object, where {object} corresponds to the the value used for .menu-item-object-{object}.', $this->plugin_slug ),
					),
					'pwpm_print_current_type_any_ancestor' => array(
						'title'   => '.current-{type}-ancestor',
						'label'   => __( 'This class is added to menu items that correspond to a hierachical ancestor of the currently rendered type, where {type} corresponds to the the value used for .menu-item-type-{type}.', $this->plugin_slug ),
					),
				),
			), // end 4th_section
			'5th_section' => array(
				'headline' => __( 'All Other Navigation Menu Items', $this->plugin_slug ),
				'description' => __( 'In this section you control some all other classes Wordpress adds to menu items.', $this->plugin_slug ),
				'options' => array(
					'pwpm_print_menu_item_object_page' => array(
						'title'   => '.menu-item-object-page',
						'label'   => __( 'This class is added to menu items that correspond to pages.', $this->plugin_slug ),
					),
					'pwpm_print_menu_item_object_category' => array(
						'title'   => '.menu-item-object-category',
						'label'   => __( 'This class is added to menu items that correspond to a category.', $this->plugin_slug ),
					),
					'pwpm_print_menu_item_object_tag' => array(
						'title'   => '.menu-item-object-tag',
						'label'   => __( 'This class is added to menu items that correspond to a tag.', $this->plugin_slug ),
					),
					'pwpm_print_menu_item_object_any' => array(
						'title'   => '.menu-item-object-{object}',
						'label'   => __( 'This class is added to every menu item, where {object} is either a post type or a taxonomy.', $this->plugin_slug ),
					),
					'pwpm_print_menu_item_object_custom' => array(
						'title'   => '.menu-item-object-{custom}',
						'label'   => __( 'This class is added to menu items that correspond to a custom post type or a custom taxonomy.', $this->plugin_slug ),
					),
					'pwpm_print_menu_item_type_post_type' => array(
						'title'   => '.menu-item-type-post_type',
						'label'   => __( 'This class is added to menu items that correspond to post types, i.e. pages or custom post types.', $this->plugin_slug ),
					),
					'pwpm_print_menu_item_type_taxonomy' => array(
						'title'   => '.menu-item-type-taxonomy',
						'label'   => __( 'This class is added to menu items that correspond to taxonomies, i.e. categories, tags, or custom taxonomies.', $this->plugin_slug ),
					),
				),
			), // end 5th_section
			'6th_section' => array(
				'headline' => __( 'Special Settings', $this->plugin_slug ),
				'description' => __( 'In this section you control some special settings.', $this->plugin_slug ),
				'options' => array(
					'pwpm_backward_compatibility_with_wp_page_menu' => array(
						'title'   => __( 'Maintain backward compatibility with wp_page_menu().', $this->plugin_slug ),
						'label'   => __( 'Adds the CSS classes of page menus to navigation menus.', $this->plugin_slug ),
					),
					'pwpm_do_not_print_parent_as_ancestor' => array(
						'title'   => __( 'Do not print parent as ancestor.', $this->plugin_slug ),
						'label'   => __( 'Does not classified the menu item which is the current parent as anchestor.', $this->plugin_slug ),
					),
				),
			), // end 6th_section
		);
		...
		foreach ( $this->form_structure as $section_key => $section_values ) {
			...
			foreach ( $section_values[ 'options' ] as $option_name => $option_values ) {
				...
				$type = 'checkbox';
				$sub_html = isset( $this->stored_settings[ $option_name ] ) ? checked( '1', $this->stored_settings[ $option_name ], false ) : '';
